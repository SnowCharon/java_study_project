...
5.QQZone登录功能实现出现的四个错误：
 ...
 6)Can not set java.util.Date field com.atguigu.qqzone.pojo.Topic.topicDate to java.time.LocalDateTime
    MySQL8.0的BUG，会自动将Timestamp类型转换成LocalDateTime
    解决方法：
