...
public class RegexTry {
    public static void main(String[] args) {
        ...
        System.out.println("你".matches("\\W")); // true    \W   -> 一个非单词字符
        ...
        System.out.println("2456foaj".matches("\\w{6,}"));

        // 验证码 必须是数字和字符  必须是4位
        System.out.println("23dhgugiu".matches("[a-zA-Z0-9]{4,}"));
        System.out.println("23_F".matches("[a-zA-Z0-9]{4}"));
        System.out.println("23dF".matches("[\\w&&[^_]]{4}"));
        System.out.println("23_F".matches("[\\w&&[^_]]{4}"));

        //人名
        System.out.println("邢彦龙".matches("\\W{2,}"));
