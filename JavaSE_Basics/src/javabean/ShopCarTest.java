...
public class ShopCarTest {
    ...
    public static void addGoods(Goods[] shopCar, Scanner sc) {
       ...
       Goods good = new Goods();
        ...
        for (int i = 0; i < shopCar.length; i++) {
            if (shopCar[i] == null) {
                shopCar[i] = good;
                System.out.println("您的商品" + good.getName() + "已经添加到购物车");
                break;
            }
    ...
    public static void queryGoods(Goods[] shopCar) {
        ...
        for (Goods good : shopCar) {
            if (good != null) {
                //展示商品
                System.out.println(good.getName() + "\t\t\t" + good.getPrice() + "\t\t\t" + good.getId() + "\t\t\t" + good.getBuyNumber());
            } else {
                //遍历结束
                break;
            }
    ...
    public static void payGoods(Goods[] shopCar) {
        ...
        for (int i = 0; i < shopCar.length; i++) {
            ...
            if (good != null) {
                sum += (good.getPrice() * good.getBuyNumber());
            } else {
                break;
            }
        }
